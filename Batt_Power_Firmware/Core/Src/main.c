...
const osThreadAttr_t BattMonTask_attributes = {
    .name = "BattMonTask",
    .cb_mem = &BattMonTaskControlBlock,
    .cb_size = sizeof(BattMonTaskControlBlock),
    .stack_mem = &BattMonTaskBuffer[0],
    .stack_size = sizeof(BattMonTaskBuffer),
...
volatile uint32_t adcResults[5] = {0};
...
int main(void) {
  ...
  BattMonTaskHandle =
      osThreadNew(StartBattMonTask, NULL, &BattMonTask_attributes);
