...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED_OFF_STATE_Pin|LED_CHARGE_STATE_Pin|LED_ON_STATE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED_OFF_STATE_Pin LED_CHARGE_STATE_Pin LED_ON_STATE_Pin */
  GPIO_InitStruct.Pin = LED_OFF_STATE_Pin|LED_CHARGE_STATE_Pin|LED_ON_STATE_Pin;
