...
# BASED ON C:\Users\abina\OneDrive - ualberta.ca\Desktop\side\EcoCar\RF-Module-Firmware\RF-Module-Firmware-HAL
...
target_link_options(
    ...
    "$<$<NOT:$<CONFIG:Debug>>:-mfloat-abi=hard>"
    -T
    "$<$<CONFIG:Debug>:${PROJECT_SOURCE_DIR}/STM32L432KBUX_FLASH.ld>"
    "$<$<NOT:$<CONFIG:Debug>>:${PROJECT_SOURCE_DIR}/STM32L432KBUX_FLASH.ld>"
)
